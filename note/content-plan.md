...
## 🔄 2026-04-19 Update: 週2投稿へ移行

SFAD スキル (2026-04-15 大幅更新: 8 Phase 化・4ファイル分割・Threat/Resilience Phase 追加) への追従とコンテンツ消化速度のため、**4/23 (木) から Qiita 週2投稿 (月・木)** に切り替え。

詳細なギャップ分析と新規記事テーマは **`note/gap-analysis.md`** 参照。本ファイルは長期計画 (Season 2/3) のブレインストーミング用として継続。最新の確定スケジュールは `schedule.json` と `gap-analysis.md` が SSOT。

---

## Season 1: 78バグから学んだ基礎（3月〜6月）

### Qiita（毎週月曜 7:00 自動公開 → **2026-04-23 より月・木 週2投稿**）
...
### Qiita 週2枠の追加予定 (gap-analysis.md Section C より抜粋)

| 日付 | 曜日 | タイトル | 種別 |
|---|---|---|---|
| 4/23 | 木 | AIに6000行のPRを書かせたら認可がゼロだった | Art-11 昇格 |
| 4/30 | 木 | テストファイルの中で本番ロジックを再実装 | Art-12 昇格 |
| 5/7 | 木 | 仕様書を4ファイルに分けたらAIが迷わなくなった | B1 新規 |
| 5/14 | 木 | AIに攻撃者視点を持たせる Three Amigos | B2 新規 |
| 5/21 | 木 | 13項目の実装ルール ― AIが破る罠リスト | B3 新規 |
| 5/28 | 木 | Threat Modeling をAIと自動化する | B4 新規 |
| 6/4 | 木 | Resilience Modeling ― 障害シナリオを仕様に書く | B5 新規 |
| 6/8 | 月 | 新SFAD cycle の 8 Phase を一周した記録 | B7 新規 |
| 6/11 | 木 | 既存コードから N+1 を仕様化する | B6 新規 |
